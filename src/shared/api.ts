...
namespace DinoSchemas {
    export function money(opts: { nonNegative?: boolean } = {}): SchemaBase<Money> {
    ...
    export function share(opts: { nonNegative?: boolean } = {}): SchemaBase<Share> {
        const { nonNegative } = opts;
...
export const Payment = new api.API('/api/payment', {
    amount: DinoSchemas.money(),
    email: Schemas.string(),
...
export const AddTransaction = new api.API<AddTransactionRequest2, Transaction>('/api/transaction', req, transactionSchema);

export const DeleteTransaction = new api.API('/api/transaction/delete', { id: Schemas.string() }, api.emptySchema);

export const TransactionSplit = new api.API('/api/transaction/split', {
...
export const TransactionDescription = new api.API('/api/transaction/description', {
    description: Schemas.string({ nonEmpty: true }),
    id: Schemas.string(),
}, api.emptySchema);

export const TransactionDate = new api.API('/api/transaction/date', {
    id: Schemas.string(),
    date: Schemas.date(),
}, api.emptySchema);

export const TransactionCategory = new api.API('/api/transaction/category', {
    id: Schemas.string(),
    category: Schemas.string(),
}, api.emptySchema);

export const TransactionAmount = new api.API('/api/transaction/amount', {
    id: Schemas.string(),
    amount: DinoSchemas.money(),
}, api.emptySchema);

export const Initialize = new api.API('/api/init', {
    index: Schemas.number(),
    ...
    debts: Schemas.optional(Schemas.values({
    ...
    history: Schemas.optional(Schemas.values(Schemas.array({
        budget: DinoSchemas.money(), spending: DinoSchemas.money(),
    }))),
    settings: Schemas.optional(settingsSchema),
} as SchemaType<InitState>);

export const AddCategory = new api.API<{ frame: number, name: string }, Category>('/api/category', {
    frame: Schemas.number(),
    name: Schemas.string({ nonEmpty: true }),
}, categorySchema);

export const DeleteCategory = new api.API('/api/category/delete', {
    id: Schemas.string(),
    frame: Schemas.number(),
}, api.emptySchema);

export const CategoryBudget = new api.API('/api/category/budget', {
    id: Schemas.string(),
    frame: Schemas.number(),
    amount: DinoSchemas.money({ nonNegative: true })
}, api.emptySchema);

export const CategoryName = new api.API('/api/category/name', {
    id: Schemas.string(),
    frame: Schemas.number(),
    name: Schemas.string({ nonEmpty: true }),
}, api.emptySchema);

export const BudgetingMove = new api.API('/api/budgeting/move', {
    to: Schemas.string(),
    from: Schemas.string(),
    amount: DinoSchemas.money(),
    frame: Schemas.number(),
...
export const Income = new api.API('/api/income', {
    income: DinoSchemas.money(),
    frame: Schemas.number(),
}, api.emptySchema);

export const Name = new api.API('/api/name', { name: Schemas.string() }, api.emptySchema);
const friendRequest = { email: Schemas.string({ nonEmpty: true }) };
export type FriendRequest = { email: string };
export const AcceptFriend = new api.API<FriendRequest, Friend>('/api/friend', friendRequest, friendSchema);
export const RejectFriend = new api.API('/api/friend/reject', friendRequest, api.emptySchema);
export const DeleteFriend = new api.API('/api/friend/delete', friendRequest, api.emptySchema);

export const UpdateSettings = new api.API('/api/settings', settingsSchema, api.emptySchema);
